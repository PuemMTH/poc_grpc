...
│       ├── simple_gen.py      # Python protobuf generator
│       └── simple_gen.sh      # Shell protobuf generator
...
Volume mounted in Docker at `./images` for persistent storage.